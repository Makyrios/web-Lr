...
function task1() {
    ...
    output.innerHTML = `<p>Ім'я користувача: ${name}<\p>\
                        <p>Прізвище користувача: ${surname}<\p>`;
}
...
function task2() {
    ...
    StudentObject.setSpecialty = specialty;
    StudentObject.setGroup = group;

    var output = document.getElementById('task2Result');
    output.innerHTML = `<p>Спеціальність студента: ${StudentObject.getSpecialty}<\p>\
                        <p>Група студента: ${StudentObject.getGroup}<\p>`;
}

function task2clearspecialty() {
    var specialtyInput = document.getElementById('studentObjectSpecialty');
    specialtyInput.value = '';
    StudentObject.clearSpecialty();
    var output = document.getElementById('task2Result');
    output.innerHTML = `<p>Спеціальність студента: ${StudentObject.getSpecialty}<\p>\
                        <p>Група студента: ${StudentObject.getGroup}<\p>`;
}
...
function task3user() {
    ...
    output.innerHTML = `<p>Ім'я користувача: ${StudentObject.getSpecialty}<\p>\
                        <p>Прізвище користувача: ${StudentObject.getGroup}<\p>`;
}
...
function task4() {
    StudentObject.prototype.showData = function() {
        ...
        output.innerHTML = `<p>Спеціальність студента: ${this.getSpecialty}<\p>\
                            <p>Група студента: ${this.getGroup}<\p>`
    }
    StudentObject2 = Object.create(StudentObject);
    Object.prototype()
    StudentObject2.showData();
